...
const AdminHome = () => {
  ...
  const {data,filtered,loading}=useSelector((state)=>{return {data:state.AdminReducer.data,filtered:state.AdminReducer.filtered,loading:state.AdminReducer.loading}})
  ...
  return (
    loading ? <Loading/> : <AdminHomeWrapper>
