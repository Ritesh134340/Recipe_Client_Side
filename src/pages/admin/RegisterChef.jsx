      ...
      <div className="chef-main">
        ...
        <div className="chef-form">
          <div className="uploaderWrapper">
            ...
            <button disabled={showProgress} onClick={handleSelect} className="image-select">{image ? "Change Image " : "Select Image"}</button>
          </div>
          <form className="from">
            ...
            <br />
            <input value={channel} type="text" onChange={(e)=>setChannel(e.target.value)}/>
            <br />
            <label>Logo URL</label>
            <br />
            <input value={logoUrl} type="text" onChange={(e)=>setLogoUrl(e.target.value)}/>
            <br />
           
            <button style={{backgroundColor:showProgress ? "gray" : "blue"}} disabled={showProgress} className="submit-btn" onClick={handleSubmit} >{showProgress ? "Submitting..." : "Submit"}</button>
          </form>
        </div>
      </div>
      </BodyWrapper>
