...
export const loginUser = (payload) => (dispatch) => {
  ...
  return axios
    .post(`${REACT_APP_SERVER_ADDRESS}/user/login`, payload)
    .then((res) => {
      return dispatch({
...
export const signupUser = (payload) => (dispatch) => {
  ...
  return axios
    .post(`${REACT_APP_SERVER_ADDRESS}/user/signup`, payload)
    .then((res) =>
      dispatch({
...
export const getProfile = (token) => (dispatch) => {
  ...
  return axios
    .get(`${process.env.REACT_APP_SERVER_ADDRESS}/user/profile`, {
...
export const getOtp = (payload) => (dispatch) => {
  ...
  return axios
    .post(`${REACT_APP_SERVER_ADDRESS}/user/get/otp`, payload)
    .then((res) => {
      return dispatch({
...
export const verifyOtp = (payload) => (dispatch) => {
  ...
  return axios
    .post(`${process.env.REACT_APP_SERVER_ADDRESS}/user/otp/verify`, payload)
    .then((res) => {
      return dispatch({
...
export const resetPassword = (payload) => (dispatch) => {
  ...
  return axios
    .patch(
      `${process.env.REACT_APP_SERVER_ADDRESS}/user/password/change`,
      payload
    )
    .then((res) => {
      return dispatch({
...
export const editProfile = (payload, header) => (dispatch) => {
  ...
  return axios
    .patch(
      `${process.env.REACT_APP_SERVER_ADDRESS}/user/edit/details`,
      payload,
      header
    )
    .then((res) => {
