  ...
  switch (type) {
    ...
    case types.GET_FAVOURITE_SUCCESS:
      return {
        ...
        loading: false,
        error: false,
        favouriteVideo: payload.favourite,
        filteredFavourite: payload.favourite,
      };
    ...
    case types.SEARCH_SUCCESS:
      return {
        ...
        loading: false,
        error: false,
        searchData: payload.searchResult,
      };
    ...
    case types.SEARCH_FILTER:
      return { ...state, filteredChannel: payload };

    case types.FILTER_FAVOURITE_VIDEOS:
      return { ...state, filteredFavourite: payload };
    ...
    case types.CHEF_SUCCESS:
      return {
        ...
        error: false,
        channelData: payload,
        filteredChannel: payload,
      };

    case types.CHEF_FAILURE:
      return { ...state, loading: false, error: true };

    case type.SUBMIT_RATING_REQUEST:
      return { ...state, loading: true, error: false };
    case type.SUBMIT_RATING_SUCCESS:
      return { ...state, loading: false, error: false };
    case type.SUBMIT_RATING_FAILURE:
      return { ...state, loading: false, error: true };
